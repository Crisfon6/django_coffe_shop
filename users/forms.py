            ...
            ButtonHolder(
                HTML(
                    ...
                    <button type="submit" class="group relative inline-block focus:outline-none focus:ring w-full">
                        ...
                        <span
                            class="relative inline-block border-2 border-current px-8 py-3 text-sm font-bold uppercase tracking-widest text-black group-active:text-opacity-75 w-full text-center"
                        >
                            Register
                        </span>
                    </button>
